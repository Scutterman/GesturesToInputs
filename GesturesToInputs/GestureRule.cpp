...
GesturesToInputs::GestureRule::GestureRule(GESTURE_RULE_TYPE type, std::string trackerName, int expectedValue, GESTURE_RULE_COMPARISON_OPERATION operation)
{
    this->type = type;
...
GesturesToInputs::GestureRule::GestureRule(GESTURE_RULE_TYPE type, std::string trackerName, GESTURE_RULE_COMPARISON_OPERATION operation, std::string comparisonTrackerName)
{
    this->type = type;
    this->trackerName = trackerName;
    this->operation = operation;
...
bool GesturesToInputs::GestureRule::compare(Tracker tracker)
{
...
bool GesturesToInputs::GestureRule::compare(Tracker tracker, Tracker trackerToCompare)
{
    // TODO:: throw exception
    if (tracker.getName() != trackerName) {
        return false;
...
bool GesturesToInputs::GestureRule::isComparingTwoTrackers()
{
    return _isComparingTwoTrackers;
}

bool GesturesToInputs::GestureRule::compare(int trackerValue)
{
